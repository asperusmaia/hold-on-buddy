...
-- Allow public read of stores
create policy if not exists "Public can read stores" on public.info_loja
...
-- Add FK to stores
alter table public.agendamentos_robustos
  add constraint if not exists agendamentos_robustos_loja_fk
